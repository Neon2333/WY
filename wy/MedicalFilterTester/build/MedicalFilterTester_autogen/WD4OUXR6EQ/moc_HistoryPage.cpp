...
#include "../../../include/Pages/HistoryPage.h"
...
static constexpr auto qt_meta_stringdata_ZN11HistoryPageE = QtMocHelpers::stringData(
    "HistoryPage",
    "loadHistory",
    "",
    "onDeleteClicked",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11HistoryPageE[] = {
...
Q_CONSTINIT const QMetaObject HistoryPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11HistoryPageE.offsetsAndSizes,
    qt_meta_data_ZN11HistoryPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11HistoryPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *HistoryPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11HistoryPageE.stringdata0))
