...
namespace {
struct qt_meta_tag_ZN13MessageDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13MessageDialogE = QtMocHelpers::stringData(
    "MessageDialog",
    "onOkClicked",
    "",
    "onCancelClicked"
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MessageDialogE[] = {
...
Q_CONSTINIT const QMetaObject MessageDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MessageDialogE.offsetsAndSizes,
    qt_meta_data_ZN13MessageDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MessageDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *MessageDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MessageDialogE.stringdata0))
